...
if y =="Русский"or "русский" or"руский"  or 'Russian':
     ...
     what  =  input ( 'что нужно геометрия , арифметика, скорость, масса  ? ')
     if what ==  "арифметика" :
          ...
          if what == '3д':
               ...
               if what == "куб" :
                    ...
                    if p=='да'or'нужна'or'да,нужна':
                         ...
                         print ( "Результат плошадь:", 4*(a + a + a)," м2 объём ",2*( a* a +   a*a +  a*a) ,"масса",2*( a* a +   a*a +  a*a)*p(sep = '')  )
...
if y =="English ":
     print ('''
              ...
              | Calculator v1.05     |
              | ____________________ |
     support for signs (*, +, -, **) and calculation of the area, perimeter ALL MEASUREMENTS IN THE  SI SYSTEM ''')
